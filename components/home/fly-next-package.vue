    ...
    <v-container>
        <v-row align="center" justify="center" dense>
            <v-col class="text-center">
                <p class="text-subtitle-1 text-indigo font-weight-medium">Fly Next Package</p>
                <p class="text-h4 font-weight-medium">Your Great Destination</p>
            </v-col>
        </v-row>
        <v-row>
            <v-col>
                <v-card flat>
                    <v-tabs v-model="tab" color="deep-purple-accent-4" align-tabs="start">
                        <v-tab :value="1" class="text-capitalize text-h6" append-icon="mdi-airplane">Flights</v-tab>
                        <v-tab :value="2" class="text-capitalize text-h6" append-icon="mdi-taxi">Car Rentals</v-tab>
                        <v-tab :value="3" class="text-capitalize text-h6" append-icon="mdi-office-building">Hotels</v-tab>
                    </v-tabs>
